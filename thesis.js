...
class FirstPersonCamera {
  constructor(camera, objects) {
    ...
    this.translation_ = new THREE.Vector3(0, 4, 0);
    this.phi_ = 0;
    this.phiSpeed_ = 8;
    this.theta_ = 0;
    this.thetaSpeed_ = 5;
...
//     this.scene_.add(box4);
     ...
     const box5 = new THREE.Mesh(
      new THREE.BoxGeometry(50, 20, 5),
      this.loadMaterial_('vintage-tile1_', 0.2));
    box.position.set(30, 0, 40);
    box.castShadow = true;
    box.receiveShadow = true;
    ...
    const box7 = new THREE.Mesh(
      ...
      this.loadMaterial_('vintage-tile1_', 0.2));
    box.position.set(70, 0, -100);
    box.castShadow = true;
    box.receiveShadow = true;
    this.scene_.add(box7);
    
    const box8 = new THREE.Mesh(
      new THREE.BoxGeometry(5, 20, 80),
      this.loadMaterial_('vintage-tile1_', 0.2));
